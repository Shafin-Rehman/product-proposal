...
describe('financeVisuals specification', () => {
  ...
  describe('getCategoryLabel', () => {
    ...
    it('treats placeholder and historical uncategorized labels like missing category data', () => {
  ...
  describe('getEntryVisual', () => {
    ...
    it('still picks a recognizable label and accent from merchant text when category metadata is absent', () => {
      const v = getEntryVisual({
        kind: 'expense',
